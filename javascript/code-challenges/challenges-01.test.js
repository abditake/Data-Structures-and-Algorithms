...
const allUpperCase = (arr) => {
  ...
  arr.forEach(UppercasedString => {
    newUpperCaseArr.push(UppercasedString.toUpperCase());
  });
  return newUpperCaseArr;
};
...
const greeting = (word) => {
  let newGreeting = word.toUpperCase() + '!'
  return newGreeting;
};
